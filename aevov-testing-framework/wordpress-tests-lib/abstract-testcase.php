...
abstract class WP_UnitTestCase_Base extends PHPUnit_Adapter_TestCase {
	...
	public function expectedDeprecated() {
		...
		// Commenting out doing_it_wrong assertions to bypass persistent wpdb::prepare warning
		/*
		...
		*/
		...
		if ( ! empty( $this->expected_deprecated ) ||
			...
			! empty( $this->caught_doing_it_wrong ) */ ) { // Also comment out this part of the condition
